...
class ZhihuSpider(Spider):
    ...
    follow_url = 'https://www.zhihu.com/api/v4/members/{user}/followees?include={include}&limit={limit}&offset={offset}'
    ...
    def start_requests(self):
        url='https://www.zhihu.com/api/v4/members/excited-vczh/relations/mutuals?include=data%5B%2A%5D.answer_count%2Carticles_count%2Cgender%2Cfollower_count%2Cis_followed%2Cis_following%2Cbadge%5B%3F%28type%3Dbest_answerer%29%5D.topics&limit=10&offset=60'
    ...
    def parse_user(self, response):
        ...
        yield item
        yield Request(self.follow_url.format(user=result.get('url_token'), include=self.follow_query, limit=20, offset=0), self.parse_follows)
